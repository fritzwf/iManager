 ...
 */
public class TextAreaPrintingDemo 
   extends javax.swing.JFrame
{
    
  private HibernateDataManagerDyn hdm = new HibernateDataManagerDyn();
  private final Font font = new Font(Font.MONOSPACED, Font.TRUETYPE_FONT, 10);

  public TextAreaPrintingDemo()
  {
    initComponents();

    File tmpFile = new File("toprint.txt");
    BufferedWriter bw;
    try
    {
      bw = new BufferedWriter(new FileWriter(tmpFile));
      StringBuilder sb = new StringBuilder();
      sb.append("   #   Line   Number   Description   Supered #    QOH   QOO   NO   BO   LS");
      sb.append("\n");
      Integer idx = 0;
      for (Item i : hdm.getAllItems())
      {
        sb.append(
        String.format("%5s %6s %25s %25.25s\n",
            idx.toString(),  i.getProductLine().getLineCode(),
            i.getItemNumber(), i.getItemDescription()));
//          sb.append(i.getSuperedItemNumber());
//          sb.append(i.getQoh());
//          sb.append(i.getQtyOnOrder());
//          sb.append(i.getNewOrder());
//          sb.append(i.isBackOrdered());
//          sb.append(i.getNumberLostSales());
        if (++idx == 100)
        {
          break;
        }
  ...
  private void initComponents() {
        ...
        headerField.setText("Inventory Report");
        ...
        //printButton.setIcon(new ImanagerProps().getDialogLogo());
  ...
  private void load(JTextArea comp, String fileName)
  {
    try
    {
      ...
      comp.read(new InputStreamReader(fis), null);
//          comp.read(
